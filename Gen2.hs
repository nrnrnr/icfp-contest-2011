...
data C = S | K | I | P | C :@: C | Get | Slot | Slot0 | Lit | CVar String | Zero
  deriving (Eq, Ord)
...
apply_slot_to_0 = S :@: (K :@: Slot) :@: Get :@: Zero
...
isSlotApp0 c = equiv c [] (Slot :@: Slot0)
isSlotApp  c = equiv c [] (Slot :@: Slot)
